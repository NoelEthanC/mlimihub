<template>
  <div class="flex bg-background text-text items-center justify-evenly">
    ...
    <div
      class="  bg-background md:w-[calc(100vw-335px)] w-full overflow-hidden absolute top-0 right-0 m-0 flex items-center justify-between flex-col"
    >
      ...
      <!-- main content -->
      <div class="w-full  bg-background overflow-y-scroll">
